...
public class Joindemo
{
    public static void main(String[] args) throws InterruptedException {
       ...
       t.join();// main Thread waits for t to finish ie child Thread to finish
        ...
        //(eg., the child thread to complete its execution before proceding . This ensures the child thread finishes
        //before the main thread continues, providing a way to enforece a specific execution order
        //This is more reliable than yield() or sleep() for ensuring the child thread runs to completiion first
