...
//Display Employee11 details belongs to Hyderabad
...
public class POJO11
{
    public static void main(String[] args)
    {
        ...
        for (int i = 0; i<ids.length; i++) {
            Employee10 e = new JavaCollections.POJO.Employee10();
            e.setDept(depts[i]);
            e.setId(ids[i]);
            e.setName(names[i]);
        ...
        for(Employee10 e1:list)
        {
            ...
            if(e1.getSalary()>300000 && e1.getSalary()<500000)
            /*
 ...
 */
         ...
         */
        {
            System.out.println("Employee11 with salary greater than 35000 not found");
        }
