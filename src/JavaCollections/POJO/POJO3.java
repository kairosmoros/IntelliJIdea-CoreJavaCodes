...
public class POJO3 {
    public static void main(String[] args) {
        ...
        for(int i=0; i<list.size(); i++)
        {
            ...
            This means the list can only store objects of type Employee2.
            So, when you do list.get(i), it returns an object of type Employee2, and it’s safe to assign it to a variable of type Employee2.
            Employee2 e = list.get(i);:
            This works only because the list is typed to Employee2.
            ...
            Employee2 e = (Employee2) list.get(i); // Unsafe and not recommended
            */
