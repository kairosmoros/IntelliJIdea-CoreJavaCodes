...
public class POJO8
{
    public static void main(String[] args)
    {
        ...
        for (int i = 0; i<ids.length; i++) {
            Employee8 e = new JavaCollections.POJO.Employee8();
            e.setDept(depts[i]);
            e.setId(ids[i]);
            e.setName(names[i]);
        ...
        for(Employee8 e1:list)
        {
            ...
            //if(e1.getLocation().equalsIgnoreCase("Hyderabad") || e1.getLocation().equalsIgnoreCase("Bangalore"))
                                                //OR
            String loc= e1.getLocation();
